...
namespace mongo {
    ...
    */
    ...
    bool DBClientWithCommands::eval(const string &dbname, const string &jscode, bool nolock, BSONObj& info, BSONElement& retValue, BSONObj *args) {
        BSONObjBuilder b;
    ...
    bool DBClientWithCommands::eval(const string &dbname, const string &jscode) {
        ...
        return eval(dbname, jscode, /*nolock*/ false, info, retValue);
    }
